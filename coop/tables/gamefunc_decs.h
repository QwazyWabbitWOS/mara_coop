...
extern void Weapon_SuperGrenade ( edict_t * ent ) ;
extern void SG_Away ( edict_t * ent ) ;
extern void Super_Grenade ( edict_t * ent , vec3_t start , vec3_t aimdir , int speed ) ;
extern void SG_Think ( edict_t * ent ) ;
extern void SG_Think2 ( edict_t * ent ) ;
extern void earthquake ( edict_t * ent ) ;
extern void earthquake_think ( edict_t * self ) ;
extern qboolean G_EntExists ( edict_t * ent ) ;
extern void G_Spawn_Explosion ( int type , vec3_t start , vec3_t origin ) ;
...
extern void Get_Target_Position ( edict_t * ent , vec3_t endpos ) ;
extern void spawn_aircraft ( edict_t * ent ) ;
extern void craft_touch ( edict_t * craft , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void launch_airstrike_salvo ( edict_t * ent , int strike_type ) ;
extern void Weapon_ClusterLauncher ( edict_t * ent ) ;
extern void weapon_clusterlauncher_fire ( edict_t * ent ) ;
extern void Weapon_PlasmaRifle ( edict_t * ent ) ;
extern void Weapon_PlasmaRifle_Fire ( edict_t * ent ) ;
extern void Plasma_Fire ( edict_t * ent , vec3_t g_offset , int damage ) ;
...
extern void Think_Airstrike ( edict_t * ent ) ;
...
extern void Radio_f ( edict_t * self , char * channel , char * msg ) ;
extern void stuffcmd ( edict_t * ent , char * s ) ;
extern void RadioToggle_f ( edict_t * self ) ;
...
extern void drop_clusterbomb ( edict_t * shooter , vec3_t start , vec3_t aimdir ) ;
extern void drop_rocket_bomb ( edict_t * shooter , vec3_t start , vec3_t dir , int damage , int speed ) ;
extern void fire_cluster ( edict_t * self , vec3_t start , vec3_t aimdir , int damage , int speed , float timer , float damage_radius ) ;
extern void Cluster_Touch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void Cluster_Explode ( edict_t * ent ) ;
extern void fire_plasma2 ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed ) ;
extern void plasma_touch2 ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void plasma_explode ( edict_t * self ) ;
...
extern char * G_CopyString ( const char * in ) ;
...
extern void SP_misc_teleporter_offworld ( edict_t * ent ) ;
...
extern void Cmd_Airstrike_f ( edict_t * ent , char * cmd ) ;
extern void Cmd_Plasma_f ( edict_t * ent ) ;
