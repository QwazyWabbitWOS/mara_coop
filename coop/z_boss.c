...
void zboss_sight (edict_t *self, edict_t *other /* unused */)
{
	if (!self)
	{
		return;
...
void trigger_zboss (edict_t *self, edict_t *other /* unused */, edict_t *activator /* unused */)
{
	edict_t	*boss = NULL;
