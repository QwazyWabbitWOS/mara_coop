...
soldier_fire(edict_t* self, int flash_number)
{
	...
	if (game.gametype == rogue_coop) /* FS: Coop: Rogue specific */
	{
		soldier_fire_rogue(self, flash_number);
		return;
	}
...
mframe_t soldier_frames_attack3_rogue[] = {
	{ai_charge, 0, NULL},
	{ai_charge, 0, NULL},
...
mmove_t soldier_move_attack3_rogue =
{
	FRAME_attak301,
	FRAME_attak309,
	soldier_frames_attack3_rogue,
	soldier_run
};
...
soldier_attack6_refire(edict_t* self)
{
	...
	if (range(self, self->enemy) < rangeSoldier)
	{
		return;
	}
...
mframe_t soldier_frames_attack6_rogue[] = {
...
mmove_t soldier_move_attack6_rogue =
{
	FRAME_runs01,
	FRAME_runs14,
	soldier_frames_attack6_rogue,
	soldier_run
};
...
mframe_t soldier_frames_duck_rogue[] = {
	...
	vec3_t point /* unused */)
{
	...
	else if (n == 2)
	{
		if (game.gametype == rogue_coop) /* FS: Coop: Rogue specific */
		{
			self->monsterinfo.currentmove = &soldier_move_death4_rogue;
		}
		else
		{
...
soldier_sidestep(edict_t* self) /* FS: Coop: Rogue specific */
{
	...
	if (self->s.skinnum <= 3)
	{
		if (self->monsterinfo.currentmove != &soldier_move_attack6_rogue)
		{
			self->monsterinfo.currentmove = &soldier_move_attack6_rogue;
		}
	}
...
soldier_duck(edict_t* self, float eta) /* FS: Coop: Rogue specific */
{
	...
	else
	{
		...
		self->monsterinfo.currentmove = &soldier_move_attack3_rogue;
		self->monsterinfo.duck_wait_time = level.time + eta + 1;
	}
...
mframe_t soldier_frames_blind[] = { /* FS: Coop: Rogue specific */
